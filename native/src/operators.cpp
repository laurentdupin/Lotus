...
VulkanOperators::VulkanOperators(VulkanContext& context)
    : context_(context),
      linear_(context.create_pipeline(
          lotus_linear_spv, lotus_linear_spv_size, 4, 12)),
      linear16_(context.create_pipeline(
          lotus_linear16_spv, lotus_linear16_spv_size, 4, 12)),
      linear_half_(context.create_pipeline(
          lotus_linear_half_spv, lotus_linear_half_spv_size, 4, 12)),
      linear16_half_(context.create_pipeline(
          lotus_linear16_half_spv,
          lotus_linear16_half_spv_size,
          4,
          12)),
      linear_vec8_(context.create_pipeline(
          lotus_linear_vec8_spv,
          lotus_linear_vec8_spv_size,
          4,
          12)),
      linear_vec8_half_(context.create_pipeline(
          lotus_linear_vec8_half_spv,
          lotus_linear_vec8_half_spv_size,
          4,
          12)),
      quantize_rows_int8_(
          ...
          ? context.create_pipeline(lotus_quantize_rows_int8_spv,
                lotus_quantize_rows_int8_spv_size, 3, 4)
          : VulkanPipeline{}),
      linear_int8_tiled_(
          context.supports_packed_int8_dot() &&
              inferbridge::native::requested_precision() ==
                  inferbridge::native::Precision::int8
          ? context.create_pipeline(lotus_linear_int8_tiled_spv,
                lotus_linear_int8_tiled_spv_size, 6, 28)
          : VulkanPipeline{}),
      gelu_(context.create_pipeline(
          lotus_gelu_spv, lotus_gelu_spv_size, 2, 4)),
      layer_norm_(context.create_pipeline(
          lotus_layer_norm_spv, lotus_layer_norm_spv_size, 4, 12)),
      ...
      bmm_value_half_(context.create_pipeline(
          lotus_bmm_value_half_spv,
          lotus_bmm_value_half_spv_size,
          3,
          8)),
      softmax_lastdim_(context.create_pipeline(
          lotus_softmax_lastdim_spv,
          lotus_softmax_lastdim_spv_size,
          2,
          8)),
      softmax_lastdim_half_(context.create_pipeline(
          lotus_softmax_lastdim_half_spv,
          lotus_softmax_lastdim_half_spv_size,
      ...
      prepare_tokens_(context.create_pipeline(
          lotus_prepare_tokens_spv,
          lotus_prepare_tokens_spv_size,
          5,
          24)),
      position_bicubic_(context.create_pipeline(
          lotus_position_bicubic_spv,
          lotus_position_bicubic_spv_size,
          {
              VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
      ...
      add_position_(context.create_pipeline(
          lotus_add_position_spv,
          lotus_add_position_spv_size,
          4,
          20)),
      add_(context.create_pipeline(
          lotus_add_spv, lotus_add_spv_size, 3, 4)),
      project_tokens_(context.create_pipeline(
          lotus_project_tokens_spv,
          lotus_project_tokens_spv_size,
          4,
          20)),
      project_tokens_half_(context.create_pipeline(
          lotus_project_tokens_half_spv,
          lotus_project_tokens_half_spv_size,
          4,
          20)),
      conv2d_(context.create_pipeline(
          lotus_conv2d_spv, lotus_conv2d_spv_size, 4, 48)),
      conv2d_pointwise_gemm_(context.create_pipeline(
          lotus_conv2d_pointwise_gemm_spv,
          lotus_conv2d_pointwise_gemm_spv_size, 4, 48)),
      conv2d8_(context.create_pipeline(
          lotus_conv2d8_spv, lotus_conv2d8_spv_size, 4, 48)),
      conv2d_half_(context.create_pipeline(
          lotus_conv2d_half_spv, lotus_conv2d_half_spv_size, 4, 48)),
      conv2d8_half_(context.create_pipeline(
          lotus_conv2d8_half_spv,
          lotus_conv2d8_half_spv_size,
          4,
          48)),
      conv2d_tiled_(context.create_pipeline(
          lotus_conv2d_tiled_spv,
          lotus_conv2d_tiled_spv_size,
          4,
          48)),
      conv2d8_tiled_(context.create_pipeline(
          lotus_conv2d8_tiled_spv,
          lotus_conv2d8_tiled_spv_size,
          4,
          48)),
      conv2d8_stride2_tiled_(context.create_pipeline(
          lotus_conv2d8_stride2_tiled_spv,
          lotus_conv2d8_stride2_tiled_spv_size,
          4,
          48)),
      conv2d8_stride2_tiled_half_(context.create_pipeline(
          lotus_conv2d8_stride2_tiled_half_spv,
          lotus_conv2d8_stride2_tiled_half_spv_size,
          4,
          48)),
      conv2d8_tiled16x8_(context.create_pipeline(
          lotus_conv2d8_tiled16x8_spv,
          lotus_conv2d8_tiled16x8_spv_size,
          4,
          48)),
      conv2d8_tiled16x8_half_(context.create_pipeline(
          lotus_conv2d8_tiled16x8_half_spv,
          lotus_conv2d8_tiled16x8_half_spv_size,
          4,
          48)),
      conv2d_winograd_(context.create_pipeline(
          lotus_conv2d_winograd_spv,
          lotus_conv2d_winograd_spv_size,
          4,
          48)),
      conv_transpose_nonoverlap_(context.create_pipeline(
          lotus_conv_transpose_nonoverlap_spv,
          lotus_conv_transpose_nonoverlap_spv_size,
          4,
          24)),
      conv_transpose_nonoverlap_half_(context.create_pipeline(
          lotus_conv_transpose_nonoverlap_half_spv,
          lotus_conv_transpose_nonoverlap_half_spv_size,
          4,
          24)),
      bilinear_align_true_(context.create_pipeline(
          lotus_bilinear_align_true_spv,
          lotus_bilinear_align_true_spv_size,
          2,
          24)),
      bilinear_align_true_image_(context.create_pipeline(
          lotus_bilinear_align_true_image_spv,
          lotus_bilinear_align_true_image_spv_size,
          {
      ...
      group_norm_silu_(context.create_pipeline(
          lotus_group_norm_silu_spv,
          lotus_group_norm_silu_spv_size, 3, 16)),
